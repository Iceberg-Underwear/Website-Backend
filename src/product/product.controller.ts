...
export class ProductController {
    ...
    @Roles("admin")
    @Post()
    async createProduct(@Body() body: {name: string, price: number, description: string, sizes: string, colors: string, images: { url: string; altText: string }[], tags: string, amount: number}) {
